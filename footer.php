<footer class="footer-section bg-white">
  <div class="container">
    <div class="row pb-3" style="text-align: right;">
      <div class="col-md-4">
        ...
        <div class="site-logo mr-auto w-20">
          <a href="index.php">
            <img src="webImg/ProtidinGerman-footer.webp" style="width:150px; height:65px; border-radius:5px; margin:20px auto;">
          </a>
        </div>
      </div>
    ...
    <div class="row border-top">
      <div class="col-md-6">
        <h3>Contact Us</h3>
        <p>protidinGerman@gmail.com  |  01737-226404</p>
        <!-- <p>01737226404 (Only WhatsApp)</p> -->
      </div>
      <div class="col-md-6 d-flex justify-content-end align-items-end flex-column">
        <p class="mb-0" style="margin-top: auto; padding-top: 20px;">
          Copyright &copy; <script>document.write(new Date().getFullYear());</script>
          All rights reserved web.com |
          Developed by <a href="https://wa.me/8801737226404" target="_blank" style="color: #7FBF4D;font-weight: bold;">Nafiz</a>
        </p>
      </div>
    </div>
