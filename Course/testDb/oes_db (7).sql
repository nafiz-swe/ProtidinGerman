...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2024 at 10:59 PM
...
INSERT INTO `class_record` (`recor_id`, `batch_number`, `record_video`, `class_topics`, `class_date`) VALUES
(1, 0, '6748db6b3595c9.79419173.mp4', 'video upload', '2024-11-29'),
(2, 140, '6748dd875a33d5.23613412.mp4', 'test 2', '2024-11-29'),
(3, 140, '6748df1f925a91.47202699.mp4', 'video store in folder', '2024-11-29'),
(4, 140, '6748e21f3f85c6.43810483.mp4', 'video store in course record  folder', '2024-11-29'),
(5, 140, '6748e284e5dd33.96528292.mp4', 'video store in adminpanel record  folder', '2024-11-29'),
(6, 167, '6748e3a2b65fc5.33573659.MP4', 'another batch c1', '2024-11-29'),
(7, 140, '6748e58f7c7c30.91393652.MP4', 'new check record folder', '2024-11-29'),
(8, 140, '6748e6a5db9f82.90710350.MOV', 'new check record folder', '2024-11-29'),
...
--
ALTER TABLE `class_record`
  MODIFY `recor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
