  ...
  <div class="col-md-12 mt-4">
    <form method="post" id="updateQuestionFrm">
      ...
      <div class="form-group">
        ...
        <input type="" name="exam_ch1" value="<?php echo $selBatch['exam_ch1']; ?>" class="form-control" required>
      </div>
      <div class="form-group">
        <legend>Choice B</legend>
        <input type="" name="exam_ch2" value="<?php echo $selBatch['exam_ch2']; ?>" class="form-control" required>
      </div>
      <div class="form-group">
        <legend>Choice C</legend>
        <input type="" name="exam_ch3" value="<?php echo $selBatch['exam_ch3']; ?>" class="form-control" required>
      </div>
      <div class="form-group">
        <legend>Choice D</legend>
        <input type="" name="exam_ch4" value="<?php echo $selBatch['exam_ch4']; ?>" class="form-control" required>
      </div>

      <div class="form-group">
        <legend class="text-success">Correct Answer</legend>
        <input type="" name="exam_final" value="<?php echo $selBatch['exam_answer']; ?>" class="form-control" required>
      </div>
