                            ...
                            <li>
                                ...
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAddExaminee">
                                        <i class="metismenu-icon fas fa-user-graduate">
                                        </i>ADD STUDENTS
                                    </a>
                                </li>
                                <li class="app-sidebar__heading"></li>
                                <li>
                                    <a href="home.php?page=manage-examinee">
                                        <i class="metismenu-icon fas fa-user-cog">
                                        </i>MANAGE STUDENTS
                                    </a>
                                </li>
                                <li class="app-sidebar__heading"></li>
                                <li>
                                    <a href="home.php?page=ranking-exam">
                                        <i class="metismenu-icon fas fa-trophy">
                                ...
                                <li>
                                    <a href="home.php?page=examinee-result">
                                        <i class="metismenu-icon fas fa-file-alt">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="home.php?page=classAttend">
                                                <i class="metismenu-icon">
                                                </i>Class Attendance
                                            </a>
                                        </li>
                                ...
                                <li>
                                    <a href="home.php?page=feedbacks">
                                        <i class="metismenu-icon fa fa-comments-o">
                                        </i>ALL FEEDBACKS
                                    </a>
                                </li>
...
function logout() {
  window.location.href = "pages/logout.php?page=teacherLogout";
}
